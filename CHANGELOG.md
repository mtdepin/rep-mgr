...
* `rep-mgr-follow <cluster> list` works fully offline (without needing IPFS to run) | [mtdepin/rep-mgr#1129](https://github.com/mtdepin/rep-mgr/issues/1129)
...
* service: `--loglevel` supports specifying levels for multiple components | [mtdepin/rep-mgr#938](https://github.com/mtdepin/rep-mgr/issues/938) | [mtdepin/rep-mgr#960](https://github.com/mtdepin/rep-mgr/issues/960)
...
* IPFS Proxy: Support `pin/update` | [mtdepin/rep-mgr#732](https://github.com/mtdepin/rep-mgr/issues/732) | [mtdepin/rep-mgr#768](https://github.com/mtdepin/rep-mgr/issues/768) | [mtdepin/rep-mgr#887](https://github.com/mtdepin/rep-mgr/issues/887)
...
* cluster: avoid random order on peer lists and listen multiaddresses | [mtdepin/rep-mgr#327](https://github.com/mtdepin/rep-mgr/issues/327) | [mtdepin/rep-mgr#878](https://github.com/mtdepin/rep-mgr/issues/878)
...
##### Features
  ...
  * Add full support for environment variables in configurations and initialization | [mtdepin/rep-mgr#656](https://github.com/mtdepin/rep-mgr/issues/656) | [mtdepin/rep-mgr#663](https://github.com/mtdepin/rep-mgr/issues/663) | [mtdepin/rep-mgr#667](https://github.com/mtdepin/rep-mgr/issues/667)
  * Switch to codecov | [mtdepin/rep-mgr#683](https://github.com/mtdepin/rep-mgr/issues/683)
  * Add auto-resolving IPFS paths | [mtdepin/rep-mgr#450](https://github.com/mtdepin/rep-mgr/issues/450) | [mtdepin/rep-mgr#634](https://github.com/mtdepin/rep-mgr/issues/634)
  * Support user-defined allocations | [mtdepin/rep-mgr#646](https://github.com/mtdepin/rep-mgr/issues/646) | [mtdepin/rep-mgr#647](https://github.com/mtdepin/rep-mgr/issues/647)
  * Support user-defined metadata in pin objects | [mtdepin/rep-mgr#681](https://github.com/mtdepin/rep-mgr/issues/681)
  * Make normal types serializable and remove `*Serial` types | [mtdepin/rep-mgr#654](https://github.com/mtdepin/rep-mgr/issues/654) | [mtdepin/rep-mgr#688](https://github.com/mtdepin/rep-mgr/issues/688) | [mtdepin/rep-mgr#700](https://github.com/mtdepin/rep-mgr/issues/700)
  * Support IPFS paths in the IPFS proxy | [mtdepin/rep-mgr#480](https://github.com/mtdepin/rep-mgr/issues/480) | [mtdepin/rep-mgr#690](https://github.com/mtdepin/rep-mgr/issues/690)
  * Use go-datastore as backend for the cluster state | [mtdepin/rep-mgr#655](https://github.com/mtdepin/rep-mgr/issues/655)
  * Upgrade dependencies | [mtdepin/rep-mgr#675](https://github.com/mtdepin/rep-mgr/issues/675) | [mtdepin/rep-mgr#679](https://github.com/mtdepin/rep-mgr/issues/679) | [mtdepin/rep-mgr#686](https://github.com/mtdepin/rep-mgr/issues/686) | [mtdepin/rep-mgr#687](https://github.com/mtdepin/rep-mgr/issues/687)
  * Adopt MIT+Apache 2 License (no more sign-off required) | [mtdepin/rep-mgr#692](https://github.com/mtdepin/rep-mgr/issues/692)
  * Add codecov configurtion file | [mtdepin/rep-mgr#693](https://github.com/mtdepin/rep-mgr/issues/693)
  * Additional tests for basic auth | [mtdepin/rep-mgr#645](https://github.com/mtdepin/rep-mgr/issues/645) | [mtdepin/rep-mgr#694](https://github.com/mtdepin/rep-mgr/issues/694)

##### Bug fixes

  * Fix docker compose tests | [mtdepin/rep-mgr#696](https://github.com/mtdepin/rep-mgr/issues/696)
  * Hide `ipfsproxy.extract_headers_ttl` and `ipfsproxy.extract_headers_path` options by default | [mtdepin/rep-mgr#699](https://github.com/mtdepin/rep-mgr/issues/699)

#### Upgrading notices

This release needs an state upgrade before starting the Cluster daemon. Run `rep-mgr-service state upgrade` or run it as `rep-mgr-service daemon --upgrade`. We recommend backing up the `~/.rep-mgr` folder or exporting the pinset with `rep-mgr-service state export`.
...
defined and the Cluster peer is started. `rep-mgr-service init` will
...
##### Features
  ...
  * Integrate [OpenCensus](https://opencensus.io) tracing and metrics into IPFS Cluster codebase | [mtdepin/rep-mgr#486](https://github.com/mtdepin/rep-mgr/issues/486) | [mtdepin/rep-mgr#658](https://github.com/mtdepin/rep-mgr/issues/658) | [mtdepin/rep-mgr#659](https://github.com/mtdepin/rep-mgr/issues/659) | [mtdepin/rep-mgr#676](https://github.com/mtdepin/rep-mgr/issues/676) | [mtdepin/rep-mgr#671](https://github.com/mtdepin/rep-mgr/issues/671) | [mtdepin/rep-mgr#674](https://github.com/mtdepin/rep-mgr/issues/674)
...
##### Deprecated
  ...
  * The snap distribution of IPFS Cluster has been removed | [mtdepin/rep-mgr#593](https://github.com/mtdepin/rep-mgr/issues/593) | [mtdepin/rep-mgr#649](https://github.com/mtdepin/rep-mgr/issues/649).
...
* The `rep-mgr-ctl status --filter` option allows to just list those
...
`rep-mgr-ctl add --no-stream` acts similarly, but buffering on the client
...
* The `rep-mgr-ctl add --quieter` flag now applies to the JSON output
...
##### Features
  ...
  * IPFS Proxy extraction to its own `API` component: `ipfsproxy` | [mtdepin/rep-mgr#453](https://github.com/mtdepin/rep-mgr/issues/453) | [mtdepin/rep-mgr#576](https://github.com/mtdepin/rep-mgr/issues/576) | [mtdepin/rep-mgr#616](https://github.com/mtdepin/rep-mgr/issues/616) | [mtdepin/rep-mgr#617](https://github.com/mtdepin/rep-mgr/issues/617)
  * Add full CORS handling to `restapi` | [mtdepin/rep-mgr#639](https://github.com/mtdepin/rep-mgr/issues/639) | [mtdepin/rep-mgr#640](https://github.com/mtdepin/rep-mgr/issues/640)
  * `restapi` configuration section entries can be overridden from environment variables | [mtdepin/rep-mgr#609](https://github.com/mtdepin/rep-mgr/issues/609)
  * Update to `go-ipfs-files` 2.0 | [mtdepin/rep-mgr#613](https://github.com/mtdepin/rep-mgr/issues/613)
  * Tests for the `/monitor/metrics` endpoint | [mtdepin/rep-mgr#587](https://github.com/mtdepin/rep-mgr/issues/587) | [mtdepin/rep-mgr#622](https://github.com/mtdepin/rep-mgr/issues/622)
  * Support `stream-channels=fase` query parameter in `/add` | [mtdepin/rep-mgr#632](https://github.com/mtdepin/rep-mgr/issues/632) | [mtdepin/rep-mgr#633](https://github.com/mtdepin/rep-mgr/issues/633)
  * Support server side `/pins` filtering  | [mtdepin/rep-mgr#445](https://github.com/mtdepin/rep-mgr/issues/445) | [mtdepin/rep-mgr#478](https://github.com/mtdepin/rep-mgr/issues/478) | [mtdepin/rep-mgr#627](https://github.com/mtdepin/rep-mgr/issues/627)
  * `rep-mgr-ctl add --no-stream` option | [mtdepin/rep-mgr#632](https://github.com/mtdepin/rep-mgr/issues/632) | [mtdepin/rep-mgr#637](https://github.com/mtdepin/rep-mgr/issues/637)
  * Upgrade dependencies and libp2p to version 6.0.29 | [mtdepin/rep-mgr#624](https://github.com/mtdepin/rep-mgr/issues/624)

##### Bug fixes

 * Respect IPFS daemon response headers on non-proxied calls | [mtdepin/rep-mgr#382](https://github.com/mtdepin/rep-mgr/issues/382) | [mtdepin/rep-mgr#623](https://github.com/mtdepin/rep-mgr/issues/623) | [mtdepin/rep-mgr#638](https://github.com/mtdepin/rep-mgr/issues/638)
 * Fix `rep-mgr-ctl` usage with HTTPs and `/dns*` hostnames | [mtdepin/rep-mgr#626](https://github.com/mtdepin/rep-mgr/issues/626)
 * Minor fixes in sharness | [mtdepin/rep-mgr#641](https://github.com/mtdepin/rep-mgr/issues/641) | [mtdepin/rep-mgr#643](https://github.com/mtdepin/rep-mgr/issues/643)
 * Fix error handling when parsing the configuration | [mtdepin/rep-mgr#642](https://github.com/mtdepin/rep-mgr/issues/642)
...
* The `GET /pins` endpoint takes a new `?filter=<filter>` option. See
  `rep-mgr-ctl status --help` for acceptable values.
...
##### Features
  ...
  * Clean (rotate) the state when running `init` | [mtdepin/rep-mgr#532](https://github.com/mtdepin/rep-mgr/issues/532) | [mtdepin/rep-mgr#553](https://github.com/mtdepin/rep-mgr/issues/553)
  * Configurable REST API headers and CORS defaults | [mtdepin/rep-mgr#578](https://github.com/mtdepin/rep-mgr/issues/578)
  * Upgrade libp2p and other deps | [mtdepin/rep-mgr#580](https://github.com/mtdepin/rep-mgr/issues/580) | [mtdepin/rep-mgr#590](https://github.com/mtdepin/rep-mgr/issues/590) | [mtdepin/rep-mgr#592](https://github.com/mtdepin/rep-mgr/issues/592) | [mtdepin/rep-mgr#598](https://github.com/mtdepin/rep-mgr/issues/598) | [mtdepin/rep-mgr#599](https://github.com/mtdepin/rep-mgr/issues/599)
  * Use `gossipsub` to broadcast metrics | [mtdepin/rep-mgr#573](https://github.com/mtdepin/rep-mgr/issues/573)
  * Download gx and gx-go from IPFS preferentially | [mtdepin/rep-mgr#577](https://github.com/mtdepin/rep-mgr/issues/577) | [mtdepin/rep-mgr#581](https://github.com/mtdepin/rep-mgr/issues/581)
  * Expose peer metrics in the API + ctl commands | [mtdepin/rep-mgr#449](https://github.com/mtdepin/rep-mgr/issues/449) | [mtdepin/rep-mgr#572](https://github.com/mtdepin/rep-mgr/issues/572) | [mtdepin/rep-mgr#589](https://github.com/mtdepin/rep-mgr/issues/589) | [mtdepin/rep-mgr#587](https://github.com/mtdepin/rep-mgr/issues/587)
  * Add a `docker-compose.yml` template, which creates a two peer cluster | [mtdepin/rep-mgr#585](https://github.com/mtdepin/rep-mgr/issues/585) | [mtdepin/rep-mgr#588](https://github.com/mtdepin/rep-mgr/issues/588)
  * Support overwriting configuration values in the `cluster` section with environmental values | [mtdepin/rep-mgr#575](https://github.com/mtdepin/rep-mgr/issues/575) | [mtdepin/rep-mgr#596](https://github.com/mtdepin/rep-mgr/issues/596)
  * Set snaps to `classic` confinement mode and revert it since approval never arrived | [mtdepin/rep-mgr#579](https://github.com/mtdepin/rep-mgr/issues/579) | [mtdepin/rep-mgr#594](https://github.com/mtdepin/rep-mgr/issues/594)
* Use Go's reverse proxy library in the proxy endpoint | [mtdepin/rep-mgr#570](https://github.com/mtdepin/rep-mgr/issues/570) | [mtdepin/rep-mgr#605](https://github.com/mtdepin/rep-mgr/issues/605)


##### Bug fixes

  * `/add` endpoints improvements and IPFS Companion compatibility | [mtdepin/rep-mgr#582](https://github.com/mtdepin/rep-mgr/issues/582) | [mtdepin/rep-mgr#569](https://github.com/mtdepin/rep-mgr/issues/569)
  * Fix adding with spaces in the name parameter | [mtdepin/rep-mgr#583](https://github.com/mtdepin/rep-mgr/issues/583)
  * Escape filter query parameter | [mtdepin/rep-mgr#586](https://github.com/mtdepin/rep-mgr/issues/586)
  * Fix some race conditions | [mtdepin/rep-mgr#597](https://github.com/mtdepin/rep-mgr/issues/597)
  * Improve pin deserialization efficiency | [mtdepin/rep-mgr#601](https://github.com/mtdepin/rep-mgr/issues/601)
  * Do not error remote pins | [mtdepin/rep-mgr#600](https://github.com/mtdepin/rep-mgr/issues/600) | [mtdepin/rep-mgr#603](https://github.com/mtdepin/rep-mgr/issues/603)
  * Clean up testing folders in `rest` and `rest/client` after tests | [mtdepin/rep-mgr#607](https://github.com/mtdepin/rep-mgr/issues/607)
...
* the second is the inclusion of a `PeerName` key in the status (`PinInfo`) objects. `rep-mgr-status` will now show peer names instead of peer IDs, making it easy to identify the status for each peer.
...
##### Features
  ...
  * Move commands to the `cmd/` folder | [mtdepin/rep-mgr#485](https://github.com/mtdepin/rep-mgr/issues/485) | [mtdepin/rep-mgr#521](https://github.com/mtdepin/rep-mgr/issues/521) | [mtdepin/rep-mgr#556](https://github.com/mtdepin/rep-mgr/issues/556)
  * Dependency upgrades: `go-dot`, `go-libp2p`, `cid` | [mtdepin/rep-mgr#533](https://github.com/mtdepin/rep-mgr/issues/533) | [mtdepin/rep-mgr#537](https://github.com/mtdepin/rep-mgr/issues/537) | [mtdepin/rep-mgr#535](https://github.com/mtdepin/rep-mgr/issues/535) | [mtdepin/rep-mgr#544](https://github.com/mtdepin/rep-mgr/issues/544) | [mtdepin/rep-mgr#561](https://github.com/mtdepin/rep-mgr/issues/561)
  * Build with go-1.11 | [mtdepin/rep-mgr#558](https://github.com/mtdepin/rep-mgr/issues/558)
  * Peer names in `PinInfo` | [mtdepin/rep-mgr#446](https://github.com/mtdepin/rep-mgr/issues/446) | [mtdepin/rep-mgr#531](https://github.com/mtdepin/rep-mgr/issues/531)
  * Wrap API client in an interface | [mtdepin/rep-mgr#447](https://github.com/mtdepin/rep-mgr/issues/447) | [mtdepin/rep-mgr#523](https://github.com/mtdepin/rep-mgr/issues/523) | [mtdepin/rep-mgr#564](https://github.com/mtdepin/rep-mgr/issues/564)
  * `Makefile`: add `prcheck` target and fix `make all` | [mtdepin/rep-mgr#536](https://github.com/mtdepin/rep-mgr/issues/536) | [mtdepin/rep-mgr#542](https://github.com/mtdepin/rep-mgr/issues/542) | [mtdepin/rep-mgr#539](https://github.com/mtdepin/rep-mgr/issues/539)
  * Docker: speed up [re]builds | [mtdepin/rep-mgr#529](https://github.com/mtdepin/rep-mgr/issues/529)
  * Re-enable keep-alives on servers | [mtdepin/rep-mgr#548](https://github.com/mtdepin/rep-mgr/issues/548) | [mtdepin/rep-mgr#560](https://github.com/mtdepin/rep-mgr/issues/560)

##### Bugfixes

  * Fix adding to cluster with unhealthy peers | [mtdepin/rep-mgr#543](https://github.com/mtdepin/rep-mgr/issues/543) | [mtdepin/rep-mgr#549](https://github.com/mtdepin/rep-mgr/issues/549)
  * Fix Snap builds and pushes: multiple architectures re-enabled | [mtdepin/rep-mgr#520](https://github.com/mtdepin/rep-mgr/issues/520) | [mtdepin/rep-mgr#554](https://github.com/mtdepin/rep-mgr/issues/554) | [mtdepin/rep-mgr#557](https://github.com/mtdepin/rep-mgr/issues/557) | [mtdepin/rep-mgr#562](https://github.com/mtdepin/rep-mgr/issues/562) | [mtdepin/rep-mgr#565](https://github.com/mtdepin/rep-mgr/issues/565)
  * Docs: Typos in Readme and some improvements | [mtdepin/rep-mgr#547](https://github.com/mtdepin/rep-mgr/issues/547) | [mtdepin/rep-mgr#567](https://github.com/mtdepin/rep-mgr/issues/567)
  * Fix tests in `stateless` PinTracker | [mtdepin/rep-mgr#552](https://github.com/mtdepin/rep-mgr/issues/552) | [mtdepin/rep-mgr#563](https://github.com/mtdepin/rep-mgr/issues/563)
...
This release requires a state upgrade migration. It can be performed with `rep-mgr-service state upgrade` or simply launching the daemon with `rep-mgr-service daemon --upgrade`.

#### List of changes

##### Features

  * Libp2p upgrades (up to v6) | [mtdepin/rep-mgr#456](https://github.com/mtdepin/rep-mgr/issues/456) | [mtdepin/rep-mgr#482](https://github.com/mtdepin/rep-mgr/issues/482)
  * Support `/dns` multiaddresses for `node_multiaddress` | [mtdepin/rep-mgr#462](https://github.com/mtdepin/rep-mgr/issues/462) | [mtdepin/rep-mgr#463](https://github.com/mtdepin/rep-mgr/issues/463)
  * Increase `state_sync_interval` to 10 minutes | [mtdepin/rep-mgr#468](https://github.com/mtdepin/rep-mgr/issues/468) | [mtdepin/rep-mgr#469](https://github.com/mtdepin/rep-mgr/issues/469)
  * Auto-interpret libp2p addresses in `rest/client`'s `APIAddr` configuration option | [mtdepin/rep-mgr#498](https://github.com/mtdepin/rep-mgr/issues/498)
  * Resolve `APIAddr` (for `/dnsaddr` usage) in `rest/client` | [mtdepin/rep-mgr#498](https://github.com/mtdepin/rep-mgr/issues/498)
  * Support for adding content to Cluster and sharding (sharding is disabled) | [mtdepin/rep-mgr#484](https://github.com/mtdepin/rep-mgr/issues/484) | [mtdepin/rep-mgr#503](https://github.com/mtdepin/rep-mgr/issues/503) | [mtdepin/rep-mgr#495](https://github.com/mtdepin/rep-mgr/issues/495) | [mtdepin/rep-mgr#504](https://github.com/mtdepin/rep-mgr/issues/504) | [mtdepin/rep-mgr#509](https://github.com/mtdepin/rep-mgr/issues/509) | [mtdepin/rep-mgr#511](https://github.com/mtdepin/rep-mgr/issues/511) | [mtdepin/rep-mgr#518](https://github.com/mtdepin/rep-mgr/issues/518)
  * `stateless` PinTracker [mtdepin/rep-mgr#308](https://github.com/mtdepin/rep-mgr/issues/308) | [mtdepin/rep-mgr#460](https://github.com/mtdepin/rep-mgr/issues/460)
  * Add `size-only=true` to `repo/stat` calls | [mtdepin/rep-mgr#507](https://github.com/mtdepin/rep-mgr/issues/507)
  * Enable DHT-based peer discovery and routing for cluster peers | [mtdepin/rep-mgr#489](https://github.com/mtdepin/rep-mgr/issues/489) | [mtdepin/rep-mgr#508](https://github.com/mtdepin/rep-mgr/issues/508)
  * Gx-go upgrade | [mtdepin/rep-mgr#517](https://github.com/mtdepin/rep-mgr/issues/517)

##### Bugfixes

  * Fix type for constants | [mtdepin/rep-mgr#455](https://github.com/mtdepin/rep-mgr/issues/455)
  * Gofmt fix | [mtdepin/rep-mgr#464](https://github.com/mtdepin/rep-mgr/issues/464)
  * Fix tests for forked repositories | [mtdepin/rep-mgr#465](https://github.com/mtdepin/rep-mgr/issues/465) | [mtdepin/rep-mgr#472](https://github.com/mtdepin/rep-mgr/issues/472)
  * Fix resolve panic on `rest/client` | [mtdepin/rep-mgr#498](https://github.com/mtdepin/rep-mgr/issues/498)
  * Fix remote pins stuck in error state | [mtdepin/rep-mgr#500](https://github.com/mtdepin/rep-mgr/issues/500) | [mtdepin/rep-mgr#460](https://github.com/mtdepin/rep-mgr/issues/460)
  * Fix running some tests with `-race` | [mtdepin/rep-mgr#340](https://github.com/mtdepin/rep-mgr/issues/340) | [mtdepin/rep-mgr#458](https://github.com/mtdepin/rep-mgr/issues/458)
  * Fix ipfs proxy `/add` endpoint | [mtdepin/rep-mgr#495](https://github.com/mtdepin/rep-mgr/issues/495) | [mtdepin/rep-mgr#81](https://github.com/mtdepin/rep-mgr/issues/81) | [mtdepin/rep-mgr#505](https://github.com/mtdepin/rep-mgr/issues/505)
  * Fix ipfs proxy not hijacking `repo/stat` | [mtdepin/rep-mgr#466](https://github.com/mtdepin/rep-mgr/issues/466) | [mtdepin/rep-mgr#514](https://github.com/mtdepin/rep-mgr/issues/514)
  * Fix some godoc comments | [mtdepin/rep-mgr#519](https://github.com/mtdepin/rep-mgr/issues/519)
...
The new `stateless` PinTracker implementation uses a new configuration subsection in the `pin_tracker` key. This is only generated with `rep-mgr-service init`. When not present, a default configuration will be used (and a warning printed).
...
##### Features
  ...
  * Consensus refactorings | [mtdepin/rep-mgr#398](https://github.com/mtdepin/rep-mgr/issues/398) | [mtdepin/rep-mgr#371](https://github.com/mtdepin/rep-mgr/issues/371)
  * Pintracker revamp | [mtdepin/rep-mgr#308](https://github.com/mtdepin/rep-mgr/issues/308) | [mtdepin/rep-mgr#383](https://github.com/mtdepin/rep-mgr/issues/383) | [mtdepin/rep-mgr#408](https://github.com/mtdepin/rep-mgr/issues/408) | [mtdepin/rep-mgr#415](https://github.com/mtdepin/rep-mgr/issues/415) | [mtdepin/rep-mgr#421](https://github.com/mtdepin/rep-mgr/issues/421) | [mtdepin/rep-mgr#427](https://github.com/mtdepin/rep-mgr/issues/427) | [mtdepin/rep-mgr#432](https://github.com/mtdepin/rep-mgr/issues/432)
  * Pubsub monitoring | [mtdepin/rep-mgr#400](https://github.com/mtdepin/rep-mgr/issues/400)
  * Force killing cluster with double CTRL-C | [mtdepin/rep-mgr#258](https://github.com/mtdepin/rep-mgr/issues/258) | [mtdepin/rep-mgr#358](https://github.com/mtdepin/rep-mgr/issues/358)
  * 3x faster testsuite | [mtdepin/rep-mgr#339](https://github.com/mtdepin/rep-mgr/issues/339) | [mtdepin/rep-mgr#350](https://github.com/mtdepin/rep-mgr/issues/350)
  * Introduce `disable_repinning` option | [mtdepin/rep-mgr#369](https://github.com/mtdepin/rep-mgr/issues/369) | [mtdepin/rep-mgr#387](https://github.com/mtdepin/rep-mgr/issues/387)
  * Documentation moved to website and fixes | [mtdepin/rep-mgr#390](https://github.com/mtdepin/rep-mgr/issues/390) | [mtdepin/rep-mgr#391](https://github.com/mtdepin/rep-mgr/issues/391) | [mtdepin/rep-mgr#393](https://github.com/mtdepin/rep-mgr/issues/393) | [mtdepin/rep-mgr#347](https://github.com/mtdepin/rep-mgr/issues/347)
  * Run Docker container with `daemon --upgrade` by default | [mtdepin/rep-mgr#394](https://github.com/mtdepin/rep-mgr/issues/394)
  * Remove the `rep-mgr-ctl peers add` command (bootstrap should be used to add peers) | [mtdepin/rep-mgr#397](https://github.com/mtdepin/rep-mgr/issues/397)
  * Add tests using HTTPs endpoints | [mtdepin/rep-mgr#191](https://github.com/mtdepin/rep-mgr/issues/191) | [mtdepin/rep-mgr#403](https://github.com/mtdepin/rep-mgr/issues/403)
  * Set `refs` as default `pinning_method` and `10` as default `concurrent_pins` | [mtdepin/rep-mgr#420](https://github.com/mtdepin/rep-mgr/issues/420)
  * Use latest `gx` and `gx-go`. Be more verbose when installing | [mtdepin/rep-mgr#418](https://github.com/mtdepin/rep-mgr/issues/418)
  * Makefile: Properly retrigger builds on source change | [mtdepin/rep-mgr#426](https://github.com/mtdepin/rep-mgr/issues/426)
  * Improvements to StateSync() | [mtdepin/rep-mgr#429](https://github.com/mtdepin/rep-mgr/issues/429)
  * Rename `rep-mgr-data` folder to `raft` | [mtdepin/rep-mgr#430](https://github.com/mtdepin/rep-mgr/issues/430)
  * Officially support go 1.10 | [mtdepin/rep-mgr#439](https://github.com/mtdepin/rep-mgr/issues/439)
  * Update to libp2p 5.0.17 | [mtdepin/rep-mgr#440](https://github.com/mtdepin/rep-mgr/issues/440)

##### Bugsfixes:

  * Don't keep peers /ip*/ addresses if we know DNS addresses for them | [mtdepin/rep-mgr#381](https://github.com/mtdepin/rep-mgr/issues/381)
  * Running cluster with wrong configuration path gives misleading error | [mtdepin/rep-mgr#343](https://github.com/mtdepin/rep-mgr/issues/343) | [mtdepin/rep-mgr#370](https://github.com/mtdepin/rep-mgr/issues/370) | [mtdepin/rep-mgr#373](https://github.com/mtdepin/rep-mgr/issues/373)
  * Do not fail when running with `daemon --upgrade` and no state is present | [mtdepin/rep-mgr#395](https://github.com/mtdepin/rep-mgr/issues/395)
  * IPFS Proxy: handle arguments passed as part of the url | [mtdepin/rep-mgr#380](https://github.com/mtdepin/rep-mgr/issues/380) | [mtdepin/rep-mgr#392](https://github.com/mtdepin/rep-mgr/issues/392)
  * WaitForUpdates() may return before state is fully synced | [mtdepin/rep-mgr#378](https://github.com/mtdepin/rep-mgr/issues/378)
  * Configuration mutates no more and shadowing is no longer necessary | [mtdepin/rep-mgr#235](https://github.com/mtdepin/rep-mgr/issues/235)
  * Govet fixes | [mtdepin/rep-mgr#417](https://github.com/mtdepin/rep-mgr/issues/417)
  * Fix release changelog when having RC tags
  * Fix lock file not being removed on cluster force-kill | [mtdepin/rep-mgr#423](https://github.com/mtdepin/rep-mgr/issues/423) | [mtdepin/rep-mgr#437](https://github.com/mtdepin/rep-mgr/issues/437)
  * Fix indirect pins not being correctly parsed | [mtdepin/rep-mgr#428](https://github.com/mtdepin/rep-mgr/issues/428) | [mtdepin/rep-mgr#436](https://github.com/mtdepin/rep-mgr/issues/436)
  * Enable NAT support in libp2p host | [mtdepin/rep-mgr#346](https://github.com/mtdepin/rep-mgr/issues/346) | [mtdepin/rep-mgr#441](https://github.com/mtdepin/rep-mgr/issues/441)
  * Fix pubsub monitor not working on ARM | [mtdepin/rep-mgr#433](https://github.com/mtdepin/rep-mgr/issues/433) | [mtdepin/rep-mgr#443](https://github.com/mtdepin/rep-mgr/issues/443)

#### Upgrading notices

##### Configuration file

This release introduces **breaking changes to the configuration file**. An error will be displayed if `rep-mgr-service` is started with an old configuration file. We recommend re-initing the configuration file altogether.

* The `peers` and `bootstrap` keys have been removed from the main section of the configuration
* You might need to provide Peer multiaddresses in a text file named `peerstore`, in your `~/.rep-mgr` folder (one per line). This allows your peers how to contact other peers.
...
The `rep-mgr-data` folder has been renamed to `raft`. Upon `rep-mgr-service daemon` start, the renaming will happen automatically if it exists. Otherwise it will be created with the new name.
...
Calling `rep-mgr-service` without subcommands no longer runs the peer. It is necessary to call `rep-mgr-service daemon`. Several daemon-specific flags have been made subcommand flags: `--bootstrap` and `--alloc`.
...
The `rep-mgr-ctl` no longer has a `peers add` subcommand. Peers should not be added this way, but rather bootstrapped to an existing running peer.
...
* Features
  * `--no-status` for `rep-mgr-ctl pin add/rm` allows to speed up adding and removing by not fetching the status one second afterwards. Useful for ingesting pinsets to cluster | [mtdepin/rep-mgr#286](https://github.com/mtdepin/rep-mgr/issues/286) | [mtdepin/rep-mgr#329](https://github.com/mtdepin/rep-mgr/issues/329)
  * `--wait` flag for `rep-mgr-ctl pin add/rm` allows to wait until a CID is fully pinned or unpinned [mtdepin/rep-mgr#338](https://github.com/mtdepin/rep-mgr/issues/338) | [mtdepin/rep-mgr#348](https://github.com/mtdepin/rep-mgr/issues/348) | [mtdepin/rep-mgr#363](https://github.com/mtdepin/rep-mgr/issues/363)
  * Support `refs` pinning method. Parallel pinning | [mtdepin/rep-mgr#326](https://github.com/mtdepin/rep-mgr/issues/326) | [mtdepin/rep-mgr#331](https://github.com/mtdepin/rep-mgr/issues/331)
  * Double default timeouts for `rep-mgr-ctl` | [mtdepin/rep-mgr#323](https://github.com/mtdepin/rep-mgr/issues/323) | [mtdepin/rep-mgr#334](https://github.com/mtdepin/rep-mgr/issues/334)
  * Better error messages during startup | [mtdepin/rep-mgr#167](https://github.com/mtdepin/rep-mgr/issues/167) | [mtdepin/rep-mgr#344](https://github.com/mtdepin/rep-mgr/issues/344) | [mtdepin/rep-mgr#353](https://github.com/mtdepin/rep-mgr/issues/353)
  * REST API client now provides an `IPFS()` method which returns a `go-ipfs-api` shell instance pointing to the proxy endpoint | [mtdepin/rep-mgr#269](https://github.com/mtdepin/rep-mgr/issues/269) | [mtdepin/rep-mgr#356](https://github.com/mtdepin/rep-mgr/issues/356)
  * REST http-api-over-libp2p. Server, client, `rep-mgr-ctl` support added | [mtdepin/rep-mgr#305](https://github.com/mtdepin/rep-mgr/issues/305) | [mtdepin/rep-mgr#349](https://github.com/mtdepin/rep-mgr/issues/349)
  * Added support for priority pins and non-recursive pins (sharding-related) | [mtdepin/rep-mgr#341](https://github.com/mtdepin/rep-mgr/issues/341) | [mtdepin/rep-mgr#342](https://github.com/mtdepin/rep-mgr/issues/342)
  * Documentation fixes | [mtdepin/rep-mgr#328](https://github.com/mtdepin/rep-mgr/issues/328) | [mtdepin/rep-mgr#357](https://github.com/mtdepin/rep-mgr/issues/357)

* Bugfixes
  * Print lock path in logs | [mtdepin/rep-mgr#332](https://github.com/mtdepin/rep-mgr/issues/332) | [mtdepin/rep-mgr#333](https://github.com/mtdepin/rep-mgr/issues/333)
...
This release will require a **state upgrade**. Run `rep-mgr-service state upgrade` in all your peers, or start cluster with `rep-mgr-service daemon --upgrade`.
...
* Bugfixes
  * Pre-built binaries panic on start | [mtdepin/rep-mgr#320](https://github.com/mtdepin/rep-mgr/issues/320)

---

### v0.3.3 - 2018-02-12

This release includes additional `rep-mgr-service state` subcommands and the connectivity graph feature.

* Features
  * `rep-mgr-service daemon --upgrade` allows to automatically run migrations before starting | [mtdepin/rep-mgr#300](https://github.com/mtdepin/rep-mgr/issues/300) | [mtdepin/rep-mgr#307](https://github.com/mtdepin/rep-mgr/issues/307)
  * `rep-mgr-service state version` reports the shared state format version | [mtdepin/rep-mgr#298](https://github.com/mtdepin/rep-mgr/issues/298) | [mtdepin/rep-mgr#307](https://github.com/mtdepin/rep-mgr/issues/307)
  * `rep-mgr-service health graph` generates a .dot graph file of cluster connectivity | [mtdepin/rep-mgr#17](https://github.com/mtdepin/rep-mgr/issues/17) | [mtdepin/rep-mgr#291](https://github.com/mtdepin/rep-mgr/issues/291) | [mtdepin/rep-mgr#311](https://github.com/mtdepin/rep-mgr/issues/311)

* Bugfixes
  * Do not upgrade state if already up to date | [mtdepin/rep-mgr#296](https://github.com/mtdepin/rep-mgr/issues/296) | [mtdepin/rep-mgr#307](https://github.com/mtdepin/rep-mgr/issues/307)
  * Fix `rep-mgr-service daemon` failing with `unknown allocation strategy` error | [mtdepin/rep-mgr#314](https://github.com/mtdepin/rep-mgr/issues/314) | [mtdepin/rep-mgr#315](https://github.com/mtdepin/rep-mgr/issues/315)
...
* Features
  * New `rep-mgr-service state export/import/cleanup` commands | [mtdepin/rep-mgr#240](https://github.com/mtdepin/rep-mgr/issues/240) | [mtdepin/rep-mgr#290](https://github.com/mtdepin/rep-mgr/issues/290)
  * New min/max replication factor control | [mtdepin/rep-mgr#277](https://github.com/mtdepin/rep-mgr/issues/277) | [mtdepin/rep-mgr#292](https://github.com/mtdepin/rep-mgr/issues/292)
  * Improved migration code | [mtdepin/rep-mgr#283](https://github.com/mtdepin/rep-mgr/issues/283)
  * `rep-mgr-service version` output simplified (see below) | [mtdepin/rep-mgr#274](https://github.com/mtdepin/rep-mgr/issues/274)
  * Testing improvements:
    * Added tests for Dockerfiles | [mtdepin/rep-mgr#200](https://github.com/mtdepin/rep-mgr/issues/200) | [mtdepin/rep-mgr#282](https://github.com/mtdepin/rep-mgr/issues/282)
    * Enabled Jenkins testing and made it work | [mtdepin/rep-mgr#256](https://github.com/mtdepin/rep-mgr/issues/256) | [mtdepin/rep-mgr#294](https://github.com/mtdepin/rep-mgr/issues/294)
  * Documentation improvements:
    * Guide contains more details on state upgrade procedures | [mtdepin/rep-mgr#270](https://github.com/mtdepin/rep-mgr/issues/270)
    * rep-mgr-ctl exit status are documented on the README | [mtdepin/rep-mgr#178](https://github.com/mtdepin/rep-mgr/issues/178)

* Bugfixes
  * Force cleanup after sharness tests | [mtdepin/rep-mgr#181](https://github.com/mtdepin/rep-mgr/issues/181) | [mtdepin/rep-mgr#288](https://github.com/mtdepin/rep-mgr/issues/288)
  * Fix state version validation on start | [mtdepin/rep-mgr#293](https://github.com/mtdepin/rep-mgr/issues/293)
  * Wait until last index is applied before attempting snapshot on shutdown | [mtdepin/rep-mgr#275](https://github.com/mtdepin/rep-mgr/issues/275)
  * Snaps from master not pushed due to bad credentials
  * Fix overpinning or underpinning of CIDs after re-join | [mtdepin/rep-mgr#222](https://github.com/mtdepin/rep-mgr/issues/222)
  * Fix unmarshaling state on top of an existing one | [mtdepin/rep-mgr#297](https://github.com/mtdepin/rep-mgr/issues/297)
  * Fix catching up on imported state | [mtdepin/rep-mgr#297](https://github.com/mtdepin/rep-mgr/issues/297)

These release is compatible with previous versions of rep-mgr on the API level, with the exception of the `rep-mgr-service version` command, which returns `x.x.x-shortcommit` rather than `rep-mgr-service version 0.3.1`. The former output is still available as `rep-mgr-service --version`.

The `replication_factor` option is deprecated, but still supported and will serve as a shortcut to set both `replication_factor_min` and `replication_factor_max` to the same value. This affects the configuration file, the REST API and the `rep-mgr-ctl pin add` command.
...
* Features
 * `rep-mgr-service state upgrade` | [mtdepin/rep-mgr#194](https://github.com/mtdepin/rep-mgr/issues/194)
 * `rep-mgr-test` Docker image runs with `ipfs:master` | [mtdepin/rep-mgr#155](https://github.com/mtdepin/rep-mgr/issues/155) | [mtdepin/rep-mgr#259](https://github.com/mtdepin/rep-mgr/issues/259)
 * `rep-mgr` Docker image only runs `rep-mgr-service` (and not the ipfs daemon anymore) | [mtdepin/rep-mgr#197](https://github.com/mtdepin/rep-mgr/issues/197) | [mtdepin/rep-mgr#155](https://github.com/mtdepin/rep-mgr/issues/155) | [mtdepin/rep-mgr#259](https://github.com/mtdepin/rep-mgr/issues/259)
 * Support for DNS multiaddresses for cluster peers | [mtdepin/rep-mgr#155](https://github.com/mtdepin/rep-mgr/issues/155) | [mtdepin/rep-mgr#259](https://github.com/mtdepin/rep-mgr/issues/259)
 * Add configuration section and options for `pin_tracker` | [mtdepin/rep-mgr#155](https://github.com/mtdepin/rep-mgr/issues/155) | [mtdepin/rep-mgr#259](https://github.com/mtdepin/rep-mgr/issues/259)
 * Add `local` flag to Status, Sync, Recover endpoints which allows to run this operations only in the peer receiving the request | [mtdepin/rep-mgr#155](https://github.com/mtdepin/rep-mgr/issues/155) | [mtdepin/rep-mgr#259](https://github.com/mtdepin/rep-mgr/issues/259)
 * Add Pin names | [mtdepin/rep-mgr#249](https://github.com/mtdepin/rep-mgr/issues/249)
 * Add Peer names | [mtdepin/rep-mgr#250](https://github.com/mtdepin/rep-mgr/issues/250)
 * New REST API Client module `github.com/mtdepin/rep-mgr/api/rest/client` allows to integrate against cluster | [mtdepin/rep-mgr#260](https://github.com/mtdepin/rep-mgr/issues/260) | [mtdepin/rep-mgr#263](https://github.com/mtdepin/rep-mgr/issues/263) | [mtdepin/rep-mgr#266](https://github.com/mtdepin/rep-mgr/issues/266)
 * A few rounds addressing code quality issues | [mtdepin/rep-mgr#264](https://github.com/mtdepin/rep-mgr/issues/264)
...
* Features
  * Upgrade Raft to 1.0.0 | [mtdepin/rep-mgr#194](https://github.com/mtdepin/rep-mgr/issues/194) | [mtdepin/rep-mgr#196](https://github.com/mtdepin/rep-mgr/issues/196)
  * Support Snaps | [mtdepin/rep-mgr#234](https://github.com/mtdepin/rep-mgr/issues/234) | [mtdepin/rep-mgr#228](https://github.com/mtdepin/rep-mgr/issues/228) | [mtdepin/rep-mgr#232](https://github.com/mtdepin/rep-mgr/issues/232)
  * Rotating backups for rep-mgr-data | [mtdepin/rep-mgr#233](https://github.com/mtdepin/rep-mgr/issues/233)
  * Bring documentation up to date with the code [mtdepin/rep-mgr#223](https://github.com/mtdepin/rep-mgr/issues/223)

Bugfixes:
  * Fix docker startup | [mtdepin/rep-mgr#216](https://github.com/mtdepin/rep-mgr/issues/216) | [mtdepin/rep-mgr#217](https://github.com/mtdepin/rep-mgr/issues/217)
  * Fix configuration save | [mtdepin/rep-mgr#213](https://github.com/mtdepin/rep-mgr/issues/213) | [mtdepin/rep-mgr#214](https://github.com/mtdepin/rep-mgr/issues/214)
  * Forward progress updates with IPFS-Proxy | [mtdepin/rep-mgr#224](https://github.com/mtdepin/rep-mgr/issues/224) | [mtdepin/rep-mgr#231](https://github.com/mtdepin/rep-mgr/issues/231)
  * Delay ipfs connect swarms on boot and safeguard against panic condition | [mtdepin/rep-mgr#238](https://github.com/mtdepin/rep-mgr/issues/238)
  * Multiple minor fixes | [mtdepin/rep-mgr#236](https://github.com/mtdepin/rep-mgr/issues/236)
...
* Note that `--bootstrap` and `--leave` flags when calling `rep-mgr-service` will be stored permanently in the configuration (see [mtdepin/rep-mgr#235](https://github.com/mtdepin/rep-mgr/issues/235)).
...
* Fixes:
  * Dockerfile runs `rep-mgr-service` instead of `ctl` | [mtdepin/rep-mgr#194](https://github.com/mtdepin/rep-mgr/issues/194) | [mtdepin/rep-mgr#196](https://github.com/mtdepin/rep-mgr/issues/196)
  * Peers and bootstrap entries in the configuration are ignored | [mtdepin/rep-mgr#203](https://github.com/mtdepin/rep-mgr/issues/203) | [mtdepin/rep-mgr#204](https://github.com/mtdepin/rep-mgr/issues/204)
  * Informers do not work on 32-bit architectures | [mtdepin/rep-mgr#202](https://github.com/mtdepin/rep-mgr/issues/202) | [mtdepin/rep-mgr#205](https://github.com/mtdepin/rep-mgr/issues/205)
  * Replication factor entry in the configuration is ignored | [mtdepin/rep-mgr#208](https://github.com/mtdepin/rep-mgr/issues/208) | [mtdepin/rep-mgr#209](https://github.com/mtdepin/rep-mgr/issues/209)
...
* Features:
  * Basic authentication support added to API component | [mtdepin/rep-mgr#121](https://github.com/mtdepin/rep-mgr/issues/121) | [mtdepin/rep-mgr#147](https://github.com/mtdepin/rep-mgr/issues/147) | [mtdepin/rep-mgr#179](https://github.com/mtdepin/rep-mgr/issues/179)
  * Copy peers to bootstrap when leaving a cluster | [mtdepin/rep-mgr#170](https://github.com/mtdepin/rep-mgr/issues/170) | [mtdepin/rep-mgr#112](https://github.com/mtdepin/rep-mgr/issues/112)
  * New configuration format | [mtdepin/rep-mgr#162](https://github.com/mtdepin/rep-mgr/issues/162) | [mtdepin/rep-mgr#177](https://github.com/mtdepin/rep-mgr/issues/177)
  * Freespace disk metric implementation. It's now the default. | [mtdepin/rep-mgr#142](https://github.com/mtdepin/rep-mgr/issues/142) | [mtdepin/rep-mgr#99](https://github.com/mtdepin/rep-mgr/issues/99)

* Fixes:
  * IPFS Connector should use only POST | [mtdepin/rep-mgr#176](https://github.com/mtdepin/rep-mgr/issues/176) | [mtdepin/rep-mgr#161](https://github.com/mtdepin/rep-mgr/issues/161)
  * `rep-mgr-ctl` exit status with error responses | [mtdepin/rep-mgr#174](https://github.com/mtdepin/rep-mgr/issues/174)
  * Sharness tests and update testing container | [mtdepin/rep-mgr#171](https://github.com/mtdepin/rep-mgr/issues/171)
  * Update Dockerfiles | [mtdepin/rep-mgr#154](https://github.com/mtdepin/rep-mgr/issues/154) | [mtdepin/rep-mgr#185](https://github.com/mtdepin/rep-mgr/issues/185)
  * `rep-mgr-service`: Do not run service with unknown subcommands | [mtdepin/rep-mgr#186](https://github.com/mtdepin/rep-mgr/issues/186)

This release introduces some breaking changes affecting configuration files and `go` integrations:

* Config: The old configuration format is no longer valid and cluster will fail to start from it. Configuration file needs to be re-initialized with `rep-mgr-service init`.
...
```
sed -i -r 's/@([0-9]+)/[ipfs\/rep-mgr#\1](https:\/\/github.com\/ipfs\/rep-mgr\/issues\/\1)/g' CHANGELOG.md
```
