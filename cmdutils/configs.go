...
import (
	...
	"github.com/mtdepin/rep-mgr/datastore/badger"
	"github.com/mtdepin/rep-mgr/datastore/leveldb"
	"github.com/mtdepin/rep-mgr/informer/disk"
	"github.com/mtdepin/rep-mgr/informer/numpin"
	"github.com/mtdepin/rep-mgr/informer/pinqueue"
	"github.com/mtdepin/rep-mgr/informer/tags"
	"github.com/mtdepin/rep-mgr/ipfsconn/ipfshttp"
...
func (ch *ConfigHelper) init() {
	...
	man.RegisterComponent(config.Kepler, cfgs.Controller)
