...
// which can be managed as part of the rep-mgr configuration file by the
// Manager.
...
// Manager represents an rep-mgr configuration which bundles
...
type jsonConfig struct {
	...
	Kepler       jsonSection      `json:"kepler,omitempty"`
}
