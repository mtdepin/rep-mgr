...
// interact with the rep-mgr-service. All methods take a
...
type Client interface {
	...
	// Version returns the rep-mgr peer's version.
	...
	// GetConnectGraph returns an rep-mgr connection graph.
...
type Config struct {
	...
	// The rep-mgr REST API endpoint in multiaddress form
	...
	// to the ipfs proxy endpoint of rep-mgr. If empty, the location
	// will be guessed from one of APIAddr/Host,
	// and the port used will be rep-mgr's proxy default port (9095)
...
// DefaultClient provides methods to interact with the rep-mgr API. Use
