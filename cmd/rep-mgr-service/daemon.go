...
import (
	...
	ipfscluster "github.com/mtdepin/rep-mgr"
	"github.com/mtdepin/rep-mgr/allocator/balanced"
	"github.com/mtdepin/rep-mgr/api/ipfsproxy"
	"github.com/mtdepin/rep-mgr/api/pinsvcapi"
	"github.com/mtdepin/rep-mgr/api/rest"
	"github.com/mtdepin/rep-mgr/cmdutils"
	"github.com/mtdepin/rep-mgr/config"
	"github.com/mtdepin/rep-mgr/consensus/crdt"
	"github.com/mtdepin/rep-mgr/consensus/raft"
	"github.com/mtdepin/rep-mgr/informer/disk"
	"github.com/mtdepin/rep-mgr/informer/pinqueue"
	"github.com/mtdepin/rep-mgr/informer/tags"
	"github.com/mtdepin/rep-mgr/monitor/pubsubmon"
...
func createCluster(
	...
	controllerConn := controllerclient.NewConnector(cfgs.Controller)

	knodeManager := knodemanager.NewKnodeManager(cfgHelper.Identity(), host.ID(), controllerConn)
	...
	if cfgMgr.IsLoadedFromJSON(config.Informer, cfgs.DiskInf.ConfigKey()) {
		diskInf, err := disk.NewInformer(cfgs.DiskInf, knodeManager)
	...
	knodeManager.SetStateTracker(tracker)
