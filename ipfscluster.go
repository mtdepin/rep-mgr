...
// cmd/rep-mgr-follow and cmd/rep-mgr-service.
package ipfscluster
...
type IPFSConnector interface {
	...
	Unpin(context.Context, api.Pin) error
	//PinLsCid(context.Context, api.Pin) (api.IPFSPinStatus, error)
	PinLsCid(context.Context, api.Pin) (api.PinDetail, error)
...
type PinTracker interface {
	...
	//GetPinFromState get pin from state
	GetPinFromState(ctx context.Context, cid api.Cid) api.Pin
}
