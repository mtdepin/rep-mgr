...
import (
	...
	"github.com/mtdepin/rep-mgr/api/rest/client"
...
func buildPaths(c *cli.Context, clusterName string) (string, string, string) {
	...
	// ~/.rep-mgr-follow/clusterName
	absPath = filepath.Join(absPath, clusterName)
	// ~/.rep-mgr-follow/clusterName/service.json
	configPath = filepath.Join(absPath, DefaultConfigFile)
	// ~/.rep-mgr-follow/clusterName/indentity.json
